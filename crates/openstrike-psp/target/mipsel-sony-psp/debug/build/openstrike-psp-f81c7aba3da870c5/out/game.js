...
`)) {
  ...
  var PANEL = "#080d12aa";
  function Hud() {
    const [st, setSt] = createSignal(strike.state());
                    ...
                    return [createComponent2(View, {
                      ...
                      get children() {
                        return [createComponent2(Text, {
                          ...
                          get children() {
                            return "HOSTILES " + st().aliveBots + "/" + st().totalBots;
                          }
                        })];
                      }
